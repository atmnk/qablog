...
$(document).ready(() => {
  ...
  themeBase = localStorage.getItem("themeBase") || document.getElementById("css-theme").getAttribute("href").match("-(default|blue).css")[1];
  setTheme(themeBase);
...
function toggleTheme() {
  themeBase = themeBase == "blue" ? "default" : "blue";
  localStorage.setItem("themeBase", themeBase);
  setTheme(themeBase);
}
function toggleThemeTo(themeBase) {
  localStorage.setItem("themeBase", themeBase);
  setTheme(themeBase);
}
function setTheme(themeBase) {
  let oldTheme = document.getElementById("css-theme").getAttribute("data-toggle")
  ...
  css.setAttribute("data-toggle",themeBase)
}
